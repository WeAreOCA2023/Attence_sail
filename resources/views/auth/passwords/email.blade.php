...
@section('content')
<div class="container d-grid items-center">
    <div class="row d-flex justify-content-center align-items-center">
        <div class="col-md-8">
            ...
            <div class="card">
                <div class="card-header">{{ __('Eメール 再設定 ※管理者へEメール変更申請が送られます') }}</div>
                <div class="card-body">
                    ...
                    <form method="POST" action="">
                        ...
                        <div class="row mb-3">
                            <label for="email" class="col-md-4 col-form-label text-md-end">{{ __('新しいEメール') }}</label>
